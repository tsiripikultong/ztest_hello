		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Hello World",
									"targetURL": "#ztesthelloztesthello-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ztesthelloztesthello-display": {
								"semanticObject": "ztesthelloztesthello",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ztesthello.ztesthello",
									"url": sap.ui.require.toUrl("ztesthello/ztesthello")
								}
							}
						}
					}
